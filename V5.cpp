...
//		system("cls");
		...
		for (int i = 0 ; i < y_max ; i++){
			...
			for (int j = -1 ; j < x_max ; j++){
				if (j != -1){
					if (smallTemparray[i][j] == '-'){
						cout<<"-  ";
					}
					else if(smallTemparray[i][j] == count){
						cout << count << "  ";
						count++;
					}
					else cout << "   ";
...
//			for(int j = 0; j < x_max; j++){
//				int k = 0;
//				if(smallTemparray[i][j] == count){
//					if(smallArray[i][j+1] != ' '){
//						while(smallArray[i][j+k] != ' '){
//							cout << smallArray[i][j+k];
//							k++;
//						}
//					}
//					if(smallArray[i+1][j] != ' ' && smallTemparray[i][j]){
//						while(smallArray[i+k][j] != ' '){
//							cout << smallArray[i+k][j];
//							k++;
//						}
//					}
//				}
...
//									break;
//								}
//	//							cout<<smallTemparray[row][j]<<endl;
//	//							system("pause");
//								word = word + letter + ' ';
//								letter++;
//								row++;
...
//									break;
//								}
//	//							cout<<smallTemparray[i][column]<<endl;
//	//							system("pause");
//								word = word + letter + ' ';
//								letter++;
//								column++;
